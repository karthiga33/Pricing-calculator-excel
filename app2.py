...
st.set_page_config(page_title="AWS Cost Estimator (Ollama)", page_icon="☁️", layout="wide")
...
st.markdown("# ☁️ AWS Cost Estimator (Groq AI)")
st.markdown('<p class="subtitle">Generate comprehensive AWS cost reports with FREE Groq AI</p>', unsafe_allow_html=True)
...
if generate_btn:
    if not uploaded_file:
        ...
        with st.spinner("🔄 Generating your cost report with Groq AI... This may take a moment..."):
            try:
...
<div style='text-align: center; color: #666; padding: 2rem 0;'>
    <p>Made with ❤️ using FREE Groq AI | © 2024</p>
</div>
""", unsafe_allow_html=True)
